        ...
        <div className="relative z-10">
          ...
          <div className="mt-8 text-center">
            ...
            >
              ...
              <span className="font-bold group-hover:underline decoration-cyan-500/50 underline-offset-2">Jayden Hindley</span>
            </a>
          </div>
        </div>
      </div>
